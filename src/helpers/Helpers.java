...
public class Helpers {
	...
	public static Test parseConfig(JSONObject cfg, String name) throws Exception {
		...
		try {
			...
			try { testElem.successHook=settings.getString("successhook"); }catch (Exception e) {}
			try { testElem.failureHook=settings.getString("failurehook"); }catch (Exception e) {}
	...
	/**
	 * Creates a running file which indicates a test still being executed
	 * This file is deleted as soon as the test is done, which creates a .data result file
	 * @param test
	 * @throws Exception 
	 * @throws IOException
	 */
